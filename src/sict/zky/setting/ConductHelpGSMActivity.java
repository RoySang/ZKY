...
import sict.zky.setting.ConductHelpXuetang.MyOnPageChangeListener;
...
public class ConductHelpGSMActivity extends Activity {
	// 定义ViewPager对象
...
//				SN.setText(SN_);
			...
			private void initView() {
				...
				view1 = mLi.inflate(R.layout.gsmhelpdocument1, null);
				view2 = mLi.inflate(R.layout.gsmhelpdocument2, null);
				view3 = mLi.inflate(R.layout.gsmhelpdocument3, null);
				view4 = mLi.inflate(R.layout.gsmhelpdocument4, null);
