...
public class DeviceScanActivity extends ListActivity
{
	...
	protected void onListItemClick(ListView l, View v, int position, long id)
	{
		...
		if (device == null)
			return;
		final Intent intent = new Intent(this, StartTestBPMActivity.class);
		
		intent.putExtra("userId", userId);
		intent.putExtra("screenName", screenName);
		intent.putExtra("userName", userName);
		intent.putExtra("thisposition", thisposition);
		intent.putExtra(StartTestBPMActivity.EXTRAS_DEVICE_NAME,
				device.getName());
		intent.putExtra(StartTestBPMActivity.EXTRAS_DEVICE_ADDRESS,
				device.getAddress());
