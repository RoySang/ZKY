...
/**
 * 缁狅紕鎮婂В蹇庣娑擃亪妞嗛柦锟�* 濮ｅ繋绔存稉顏堟闁界喎顕惔鏃傛畱娣団剝浼呴柈鐣岀拨鐎规艾�?��reference娑擃厺绨�?*/
...
//        addPreferencesFromResource(R.xml.alarm_prefs);
        ...
        Button b = (Button) findViewById(R.id.alarm_save);//保存
        ...
        final Button revert = (Button) findViewById(R.id.alarm_revert);//还原
        ...
        b = (Button) findViewById(R.id.alarm_delete);//删除
        if (mId == -1) {
            b.setEnabled(false);
        } else {
            b.setOnClickListener(new View.OnClickListener() {
