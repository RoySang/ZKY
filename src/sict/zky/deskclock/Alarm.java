...
public final class Alarm implements Parcelable {
    ...
    public static class Columns implements BaseColumns {
        /**
         * The content:// 濞戞捇缂氱换鏍ㄧ▔椤忓洢锟介悗瑙勭煯缁犵喐绋夐敓浠嬪殝闁稿繐褰夐棅鈺呮儍閸掑墔l
         */
        public static final Uri CONTENT_URI =
                Uri.parse("content://sict.zky.deskclock/alarm");
    ...
    //////////////////////////////
    // End 婵絽绻嬬粩鎾礆濡わ拷鏆板☉鏂款槺缁劑寮堕敓锟�  //////////////////////////////

    // 閻庣數鎳撶花鏌ユ儍閸曨偄褰嗛柛蹇氫含濞堟垵袙韫囧海顏遍柛鎺擃殘濞堟垿寮伴悩鑼
    public int        id;
    ...
    //闁告帗绋戠紓鎾寸▔閿熶粙鍤嬪娑欘焾椤撴槒銇愰幘鍐差�?��哄啫鐖煎Λ鍧楁儍閸曨垱顦梺鏂ゆ嫹    public Alarm() {
